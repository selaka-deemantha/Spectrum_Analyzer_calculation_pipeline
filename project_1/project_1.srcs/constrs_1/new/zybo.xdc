...
#Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { vco_start }]; #IO_L19N_T3_VREF_35 Sch=SW0
...
##Pmod Header JC
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 } [get_ports { o_vco_le_0 }]; #IO_L10N_T1_34 Sch=JC1_N
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { o_vco_clk_0 }]; #IO_L10P_T1_34 Sch=JC1_P
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { o_vco_data_0 }]; #IO_L1N_T0_34 Sch=JC2_N
